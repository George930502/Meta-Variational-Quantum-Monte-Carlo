...
class RBM(nn.Module):
    def __init__(self, num_visible, num_hidden):
        ...
        # --- FIX: Store num_visible as an attribute ---
    ...
    def forward(self, v):
        ...
        # Use softplus for numerical stability, which is equivalent to log(2*cosh(x)) up to a constant
...
class CNN(nn.Module):
    def __init__(self, num_spins, depth):
        ...
        # This was already correct, but we'll be consistent
